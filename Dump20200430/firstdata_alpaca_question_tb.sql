...
INSERT INTO `question_tb` VALUES (1,'Q. c++의 클래스 선언 시,클래스 안의 함수에서 사용하는 변수를 그 함수 선언보다 늦게 선언해도 잘 동작하는가?',1),(2,'Q.생성자를 가리키는 함수 포인터를 전달하는 방법은 무엇입니까?',2),(3,'Q.전체적으로 연산자 오버로딩에서 매개변수에 거의 참조자를 붙여주던데이것은 규약인가요? 만약 참조자를 붙여줘서 이점이 있다면 거의 모든 함수에서는 매개변수로 참조자를 넣어주는것이 좋나요?',3);
...
-- Dump completed on 2020-04-30 22:40:40
